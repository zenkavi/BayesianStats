...
Testing `deSolve` ODE solver for data generation
...
params = cur_args_dict
params$I[1,]
interpol <- approxfun(x=seq(1, params$Tmax, params$dt), y=params$I[1,], ties=max)
interpol(7)
params$I[1,]

net_dat_ode =  ode(y = state0, times = times, func = dx_dt, parms = cur_args_dict, method="rk4")

data.frame(net_dat_ode) %>%
