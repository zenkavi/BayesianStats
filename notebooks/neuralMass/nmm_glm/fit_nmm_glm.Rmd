...
If the time series of non-stim hub nodes are more similar to stim hub nodes than the non-stim local community nodes (which as shown above are not as strongly connected to stim nodes) other nodes are to stim nodes?
