...
big_W_args_dict$s = .55
big_W_args_dict$g = .55
...
**When $\frac{s}{g}=1$ AND $s>.5$ activity doesn't turn off after task does.**

**When $\frac{s}{g}<1$ activity doesn't turn off after task does.**
