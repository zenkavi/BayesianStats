...
What is the effect of removing network activity from the extended regression depending on the ratio of `s` to `g` (ie if the network is driven primarily by the network)
