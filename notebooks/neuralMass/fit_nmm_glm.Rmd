...
round(run_ext_glm(net_dat_debug, cur_args_dict, task_reg = cur_args_dict$I[1,], net_act = FALSE)$ext_task_betas, 4)
```
...
print("Corrected estimates without network activity")
round(run_ext_glm(big_W_net_dat_debug, big_W_args_dict, task_reg = big_W_args_dict$I[1,], net_act = FALSE)$ext_task_betas, 4)
```
