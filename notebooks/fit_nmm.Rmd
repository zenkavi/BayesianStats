...
Does the debug output have all the bits I need for the equation above? Yes.

```{r}
names(net_dat_debug$int_out)
```

Confirm that the residuals are 0 for stimulated node. Stim node for this data is node 1.
