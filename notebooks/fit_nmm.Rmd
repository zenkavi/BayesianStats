...
Why don't we observe the same problem when the stimulation is short?
...
round(run_ext_glm(loop_net_dat_debug, cur_args_dict, task_reg = loop_args_dict$I[2,])$ext_task_betas, 4)
```

### Loop short stimulation

Is the overcorrection for the loop stimulation due to the loop or task on length?
