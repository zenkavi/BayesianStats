...
```{r}
lynx_hare_df = read.csv("../../stanModels/stanCaseStudies/hudson-bay-lynx-hare.csv", comment.char="#")
```
...
```{r}
mod = cmdstan_model("../../stanModels/stanCaseStudies/lotka-volterra.stan")
```
