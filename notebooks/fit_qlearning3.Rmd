...
Are they indistinguishable because the model estimates the same value for the two learning rates since there is no constraint on them?
...
```{r}
m = stan_model('../stanModels/qLearning/QLearning_.stan')
```
