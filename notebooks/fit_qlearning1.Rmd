...
Pair plots show that Dde to the independence assumption built into ADVI the posteriors of parameter estimates are uncorrelated. The NUTS samples show that the independence assumption is violated and that the parameters are negatively correlated. This dependency leads to unidentifiability (i.e. there are multiple combinations of the parameters that are equally likely to generate the observed data).  
